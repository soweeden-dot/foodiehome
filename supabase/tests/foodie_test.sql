...
do $$ begin
  ...
  if (select content from public.memories where key = 'grocery.shopping_day')
...
update public.memories set content = 'Sundays after all.'
...
do $$ begin
  begin
    perform public.foodie_save_memory(
...
select public.foodie_add_grocery_item(
...
do $$ begin
  ...
  if not exists (select 1 from public.grocery_items
...
do $$ begin
  begin
    perform public.foodie_add_grocery_item(
...
set request.jwt.claim.sub = '00000000-0000-0000-0000-00000000000a';
insert into public.agent_conversations (id, household_id, created_by, context_tag)
  values ('50000000-0000-0000-0000-000000000001',
          '10000000-0000-0000-0000-000000000001',
          '00000000-0000-0000-0000-00000000000a', 'chat');
insert into public.agent_messages (household_id, conversation_id, role, content)
...
do $$ begin
  begin
    insert into public.agent_actions (household_id, tool_name, requested_by)
