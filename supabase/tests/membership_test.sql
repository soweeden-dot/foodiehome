...
select upper(invite_code) as invite_code_shared
  from public.households where id = '10000000-0000-0000-0000-000000000001' \gset
...
select public.redeem_household_invite(:'invite_code_shared');
select public.redeem_household_invite(:'invite_code_shared');
...
do $$ begin
  begin
    perform public.redeem_household_invite('nope-not-a-code');
...
do $$ begin
  begin
    perform public.regenerate_invite_code('10000000-0000-0000-0000-000000000001');
...
begin
  select invite_code into old_code
    from public.households where id = '10000000-0000-0000-0000-000000000001';
  new_code := public.regenerate_invite_code('10000000-0000-0000-0000-000000000001');
  if new_code = old_code or new_code is null then
    raise exception 'invite code was not rotated';
  end if;
  begin
    perform public.redeem_household_invite(old_code);
...
set request.jwt.claim.sub = '00000000-0000-0000-0000-00000000000c';
select public.leave_household('10000000-0000-0000-0000-000000000001');
do $$ begin
  begin
    perform public.leave_household('10000000-0000-0000-0000-000000000001');
...
update public.food_items set notes = 'user edit'
  where id = '20000000-0000-0000-0000-000000000001';
do $$ begin
  if (select source from public.record_history
...
update public.food_items set notes = 'foodie edit'
  where id = '20000000-0000-0000-0000-000000000001';
do $$ begin
  if (select source from public.record_history
       where table_name = 'food_items' and op = 'UPDATE'
...
insert into public.fermentation_projects (id, household_id, project_type, name)
  values ('40000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 'sourdough_starter', 'Bubbles');
insert into public.fermentation_logs (household_id, project_id, log_type, notes, author)
